...
/*   Updated: 2017/05/10 18:26:08 by nvarela          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		ft_print_usageone(t_map *map, int y)
{
	...
	mlx_string_put(map->mlx, map->win, 125, y + 100, DEF_COLOR, "press 'z' key");
}
...
static void		ft_print_usagetwo(t_map *map, int y)
{
	...
	mlx_string_put(map->mlx, map->win, 425, y + 60, DEF_COLOR, "press 'esc' key");
	mlx_string_put(map->mlx, map->win, 300, y + 80, DEF_COLOR, "Zoom ++:");
	mlx_string_put(map->mlx, map->win, 425, y + 80, DEF_COLOR, "press '+' key (pav num)");
	mlx_string_put(map->mlx, map->win, 300, y + 100, DEF_COLOR, "Zoom -- :");
	mlx_string_put(map->mlx, map->win, 425, y + 100, DEF_COLOR, "press '-' key (pav num)");
}
